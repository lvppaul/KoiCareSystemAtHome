...
const UpdatePondDetail = ({ show, setShow, pond, setPond }) => {
  ...
  const handleSubmitPondUpdate = async (event) => {
    ...
    try {
      ...
      setLoading(false);
      handleClose();
      setToastMessage("Pond updated successful!");
    } catch (error) {
      console.error("Error updating pond:", error);
      setLoading(false);
      setToastMessage("Pond updated failed!");
    }
  };
              ...
              <Col>
                ...
                <Row>
                  <Form.Group as={Col} controlId="formGridVolume">
                    ...
                    <Form.Control
                      type="number"
                      placeholder="Enter pond volume (liter)"
                      name="volume"
