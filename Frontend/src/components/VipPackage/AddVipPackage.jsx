  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        setToastMessage("Vip Package added successfully!");
        setShow(false);
      } else {
        setToastMessage("Vip Package added failed!");
      }
    } catch (error) {
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            <Form.Group controlId="formName">
              ...
              <Form.Control type="text" name="name" value={vipPackage.name} onChange={handleInputChange} required />
            </Form.Group>
            <Form.Group controlId="formPrice">
              <Form.Label>Price</Form.Label>
              <Form.Control type="text" name="price" value={vipPackage.price} onChange={handlePriceChange} required />
            </Form.Group>
            <Form.Group controlId="formDuration">
              <Form.Label>Duration (Month)</Form.Label>
              <Form.Control as="select" name="options" value={vipPackage.options} onChange={handleInputChange} required>
