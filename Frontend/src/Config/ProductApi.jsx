...
const getProdcutOutOfStock = async (shopId) => {
  try {
    const response = await api.get("Product/GetProductOutOfStockInShop", {
      params: {
        ShopId: shopId,
      },
      headers: {
...
const getProductDiscontinued = async (shopId) => {
  try {
    const response = await api.get("Product/GetProductDiscontinuedInShop", {
      params: {
        ShopId: shopId,
      },
      headers: {
...
const getProductInStock = async (shopId) => {
  try {
    const response = await api.get(`Product/GetProductOnShop/${shopId}`, {
      headers: {
        accept: "text/plain",
      },
    });
...
const getProductsByShopIdAndCategoryId = async (shopId, categoryId) => {
  try {
    const response = await api.get(`Product/GetProductByCategoryIdInShop/${shopId}/${categoryId}`, {
      headers: {
        accept: "text/plain",
      },
    });
    ...
    console.error(`Error fetching products with shopId ${shopId} and categoryId ${categoryId}:`, error);
    throw error;
  }
};
